...
import org.datatransferproject.datatransfer.generic.GenericConfigSpecification;
...
public class GenericPostsImporter
    ...
    private final GenericConfigSpecification genericConfigSpec;
    ...
    public GenericPostsImporter(
        ...
        this.genericConfigSpec = genericConfigSpec;
    }
    ...
    private String insertActivity(
        ...
        Request.Builder requestBuilder = new Request.Builder().url(genericConfigSpec.getBaseURL());
